...
const ConfigScreen = ({ onGenerate, isLoading }) => {
    ...
    const FormCategory = ({ title, children }) => (
        <div className="p-6 rounded-lg shadow-lg bg-[#fbfaf5] border border-stone-300">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-black p-4 sm:p-8 flex items-center justify-center font-serif">
...
const LoadingScreen = () => (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center text-stone-200 font-serif">
...
const GameScreen = ({ gameData, onBack }) => {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-black text-stone-800 p-4 font-serif flex flex-col">
                <header className="flex-shrink-0 mb-4 bg-stone-300 p-4 rounded-lg shadow-lg border border-stone-400">
                ...
                <div className="flex-grow grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-0">
                    <div className="lg:col-span-1 bg-stone-300 backdrop-blur-sm rounded-lg p-4 border border-stone-400 flex flex-col shadow-lg">
                    ...
                    <div className="lg:col-span-3 min-h-[50vh] lg:min-h-0 bg-stone-200/90 p-8 rounded-lg overflow-y-auto custom-scrollbar border-2 border-stone-400 shadow-inner">
                        {selectedDocument ? (
                            <>
